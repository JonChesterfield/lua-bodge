...
/* Local patch begins */
/* LUA_USE_LINUX without readline. dlopen is already a dependency */
#define LUA_USE_POSIX
#define LUA_USE_DLOPEN
/* Local patch ends */

/* Computed goto is fine, but #including within a function doesn't
   work with the current amalgamation script. Use a switch instead */
...
*/
    ...
    defined(__ELF__)		/* { */
/* Local patch begins */
#if 0 /* Hiding symbols is handled by the build system */
